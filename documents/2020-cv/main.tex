...
\begin{itemize}[leftmargin=*]
    ...
    \item Owned technical solution from design to launch, including the planning and end-to-end development of the app.
...
\renewcommand\labelitemi{\tiny$\bullet$}
    ...
    \item \textbf{AI and ML:} Machine Learning Specialization (Andrew NG - Coursera),  Practical Deep Learning for Coders (fast.ai),  Neural Networks for Machine Learning (Geoffrey Hinton - UofT)
