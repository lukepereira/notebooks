...
\end{lstlisting}
    ...
    \begin{enumerate}
        ...
        \item Iterate over the auxiliary array, add the number to left of the current number, generating an accumulative sum. This will later give us the starting position of the current number since the counts of the previous numbers will need be allocated in the indices to the left in a sorted array.
...
\end{lstlisting}
    ...
    Subproblems for strings or sequences will be one of the following:
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Consider making a space-time trade off, usually in the form of a hash-table or cached results.
