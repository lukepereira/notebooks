...
% \subsection{Neural Architecture Speculations}
% The development of sophisticated learning procedure have been built on a few key assumptions of the early models of the brain that have turned out to be highly effective. The assumptions are as follows:
% \begin{itemize}
%     \item The brain is a hierarchical or sequential composition of layered networks that specialize in certain functions but are closely integrated with one another.
%     \item There exists a network that processes complex sensory input into encoded data before communicating it to layers above it, i.e. in a bottom-up manner. This latent representation of observations of reality can be thought of as a symbolic and denoised representation of the world.
